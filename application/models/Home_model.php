...
class Home_model extends CI_Model
{
  ...
  public function loadCategories(){
    ...
    return $this->db->select('*')->from('location')->get()->result_array();
  }
  ...
  public function search_get_allservices($limit,$start,$sloc,$scat,$exp,$title){   
    if($title != ''){
  ...
  public function search_allservicecount($sloc,$scat,$exp,$title){
  if($title != ''){
