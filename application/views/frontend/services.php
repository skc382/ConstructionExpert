...
<form role="search" action="<?=$base_url?>search-services" method="post">
...
<?php
   if(is_array($locations)){
     foreach($locations as $loc){
       echo '<option value='.$loc['location'].'> '.ucfirst($loc['location']).'</option>';
     }
   }
?>
</select>
...
<div class="tab-content">
  ...
  <div class="row">
       <?php 
       // echo $total_rows;
          if(is_array($myservice) && count($myservice) > 0){
        ...
        ?>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="featured-box">       
                        <div class="feature-content">
                            ...
                            <h4><a href="<?=$base_url?>serviceprovider-details/<?=$mys['user_serviceid']?>"><?=$mys['servicetitle']?> </a></h4>
                            <div class="meta-tag">
                            <span>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="featured-box">       
                        <div class="feature-content">
                            <p class="dsc h3 text-center">No results found.</p>
                        </div><!--  feature-content -->
                    </div><!--  feature-box -->
               </div><!--  end-col -->
          <?php }
