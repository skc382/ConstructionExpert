...
<li><a class="twitter" href="<?=$web[0]['tw']?>"><i class="lni-instagram-filled"></i></a></li>
</ul>
</div>
</div>
<div class="col-lg-4 col-md-4 col-xs-6 col-mb-12">
...
<li>
<strong><i class="lni-map-marker"></i></strong><span><a href="https://goo.gl/maps/PvgpLVmnvFjYdM4T9" target="new"><?=$web[0]['siteaddress'];?></a></span>
</li>
</ul>
</div>
</div>
...
<p><a target="_blank" href="<?=$base_url?>"> Copyrights &copy; <?=date('Y');?> | by Constructionexpert.in</a></p>
</div>
</div>
</div>
</div>
