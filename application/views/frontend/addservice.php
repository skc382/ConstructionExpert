...
<select name="catid" id="catid" required class="tg-select form-control" >
...
<select name="tagid[]" id="tagid[]" multiple class="tg-select form-control selectpicker">
...
<textarea class="form-control summernote input-md" name="sdesc" id="sdesc" ></textarea>
</div>
<div class="form-group mb-3">
