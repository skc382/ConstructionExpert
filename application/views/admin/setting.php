                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" pattern="^\d{10}$"  title="Phone number 10 digit" class="form-control" placeholder="Enter contact number" name="sitephone" id="sitephone" value="<?=$web[0]['sitephone']?>"  >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="Enter instagram link" name="insta" id="insta" value="<?=$web[0]['insta']?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file"  class="form-control" name="hfile" id="hfile">
                            </div>
                          </div>
                        </div>                 
                        <div class="row">
