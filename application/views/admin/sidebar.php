					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="<?php if($page == 'location'){ echo 'active';}?>"> 
								<a href="<?=$base_url?>service-location"><i class="fe fe-location"></i> <span>Service Location</span></a>
							</li>
							...
							<li class="<?php if($page == 'enquiries' || $page == 'invitesrs'){ echo 'active';}?>"> 
								<a href="<?=$base_url?>customer-enquiries"><i class="fe fe-messanger"></i> <span>Customer Ads</span></a>
							</li>
							<li class="submenu">
