            ...
            <div class="header">
                ...
                <div class="header-left">
                    <a href="<?=$base_url?>dashboard" class="logo">
						<img src="<?=$base_url?>backend/img/web/<?=$web[0]['headerlogo']?>" alt="Logo">            
					</a>
						...
						<div class="dropdown-menu">
							<div class="user-header">
								<div class="avatar avatar-sm">
									<img src="<?=$base_url?>backend/img/web/<?=$web[0]['headerlogo']?>" alt="User Image" class="avatar-img rounded-circle">
								</div>
								<div class="user-text">
