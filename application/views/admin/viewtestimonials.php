  ...
  <div class="page-wrapper">
            ...
            <div class="col-sm-7 col-auto">
              ...
              <div class="col-sm-5 col">
								<a href="#Add_Country" data-toggle="modal" class="btn btn-primary float-right mt-2">Add Testimonial</a>
							</div>				
						</div>
					</div>
					<!-- /Page Header -->
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<p class="mb-4">Are you sure want to delete this?</p>
								<input type="hidden" id="cid">
								<button type="button" class="btn btn-primary" id="delfeed">Yes </button>
							...
							<input type="hidden" name="<?php echo $csrf['name']; ?>" id="<?php echo $csrf['name']; ?>" value="<?php echo $csrf['hash']; ?>">
								<div class="row form-row">
									<div class="col-12 col-sm-12">
										<div class="form-group">
                    <label> Name</label>
											<input type="text" class="form-control" name="euname" id="euname">
										</div>
									</div>
                  <div class="col-12 col-sm-12">
										<div class="form-group">
											<label>Feedback Message</label>
											<textarea name="emsg" id="emsg" class="form-control"></textarea>
										</div>
									</div>
								</div>
