  ...
  <div class="page-wrapper">
            ...
            <div class="col-sm-7 col-auto">
							...
							<div class="col-sm-5 col">
								<a href="#Add_Country" data-toggle="modal" class="btn btn-primary float-right mt-2">Add</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
							...
							<input type="hidden" name="<?php echo $csrf['name']; ?>" id="<?php echo $csrf['name']; ?>" value="<?php echo $csrf['hash']; ?>">
								<div class="row form-row">
									 <div class="col-12 col-sm-6">
										<div class="form-group">
										    <label for=""></label>
								        <img class="avatar-img" src="" id="indimg">
										</div>
									</div>
								</div>
								<div class="row form-row">
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="ecatname" id="ecatname">
										</div>
									</div>	
									<div class="col-12 col-sm-6">
										<div class="form-group">
					...
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<button type="button" class="btn btn-primary" id="delctry">Yes </button>
