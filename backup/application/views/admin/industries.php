  ...
  <div class="page-wrapper">
          ...
          <div class="row">
								...
								<div class="row form-row">
									<div class="col-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="indname" id="indname">
										</div>
									</div>
									<div class="col-12 col-sm-6">
										<div class="form-group">
			...
			<!-- Edit Details Modal -->
			<div class="modal fade" id="edit_industry_details" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						<div class="modal-header">
					...
					<!--	<div class="modal-header">
						...
						<div class="modal-body">
							<div class="form-content p-2">
								...
								<input type="hidden" id="indid">
								<button type="button" class="btn btn-primary" id="delind">Yes </button>
