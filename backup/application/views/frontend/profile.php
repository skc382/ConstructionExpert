...
<input readonly class="form-control input-md" id="phone" name="phone" type="text" value="<?=$upr['phone']?>">
</div>
<div class="form-group mb-3">
...
<div class="dashboard-box">
<h2 class="dashbord-title">Company Detail</h2>
</div>
<div class="dashboard-wrapper">
<form id="cmpform">
<p  id="cmp_error"></p>
...
<input class="form-control input-md" name="cname" id="cname" type="text" value="<?=isset($supr['companyname']) ? $supr['companyname'] : ""?>">
</div>
<div class="form-group mb-3">
<label class="control-label">About</label>
<textarea class="form-control summernote input-md" name="about" id="about"><?=isset($supr['about']) ? html_entity_decode($supr['about']) : ""?></textarea>
</div>
<div class="form-group mb-3">
<label class="control-label">Enter Address</label>
<textarea class="form-control input-md" name="address" id="address"><?=isset($supr['address']) ? $supr['address'] : ""?></textarea>
</div>
