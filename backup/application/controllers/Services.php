...
if(!empty($_FILES['file']['name'][0]))
  ...
  public function search1(){
    ...
    $config["total_rows"] = $this->home->search_allservicecount($sloc,$scat,$price,$exp,$keyword);
    $config["per_page"] = 10;
    ...
    $data=array(
      ...
      'myservice'=> $this->home->search_get_allservices($config["per_page"],$page,$sloc,$scat,$price,$exp,$keyword)
    ); 
    $this->load->vars($this->data);
